...
QR scan app for scouts, in Flutter (an Android + iOS cross-platform solution)
...
1. Fork this repo.
    1. Login to GitHub and navigate to [this repo](https://github.com/frc1678/scout-QR-2019).
    1. Click the 'Fork' button in the upper right hand corner.
1. Clone your forked repo.
    * `git clone https://github.com/<your_github_username>/scout-QR-2019.git`
1. Add this repo as a remote.
    * `git remote add upstream https://github.com/frc1678/scout-QR-2019.git`
...
To add a remote, use `git remote add <name_of_person> https://github.com/<their_username>/scout-QR-2019.git`.
